  ...
  return (
    ...
    >
      <g style={{ mixBlendMode: 'saturation' }}>
        <path
          d='M70.864 24.5368C74.8361 26.8137 74.8948 32.5227 70.9704 34.8836L49.5805 47.7516C45.6051 50.1432 40.5369 47.3128 40.4893 42.6743L40.2294 17.3962C40.1817 12.7578 45.1906 9.82014 49.2143 12.1267L70.864 24.5368Z'
          fill='#0DFFFF'
        />
      </g>
